...
public class GeneratorTest {
	...
	public static void main(String[] args) {
		...
		Lambkit.setBootArg("lambkit.generator.outRootDir", "D:/lambkit-workspace/workspace/Lambkit-opensource/lambkit-jdk1.7/src/main/java");
		Lambkit.setBootArg("lambkit.generator.basepackage", "com.lambkit.module.upms");
		...
		options.put("includedTables", "upms_credit, upms_favorites, upms_log, upms_organization, upms_permission, upms_role, upms_role_permission, upms_sign, upms_system, upms_tag, upms_user, upms_user_credit, upms_user_organization, upms_user_permission, upms_user_role");
