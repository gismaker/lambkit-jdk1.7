 ...
 * @since 1.0
 */
public class UpmsUserCreditValidator extends BaseValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsUserCredit.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsUserCredit.class.getSimpleName());
	}
}
