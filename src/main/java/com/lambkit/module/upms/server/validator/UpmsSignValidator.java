 ...
 * @since 1.0
 */
public class UpmsSignValidator extends BaseValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsSign.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsSign.class.getSimpleName());
	}
}
