 ...
 */
/**
 * upms_user_credit标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:upms_user_credit信息}
 * @author lambkit
 */
public class UpmsUserCreditDirective extends BaseDirectiveModel {
	...
	public void executeMe(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sql = " from upms_user_credit where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
		...
		UpmsUserCreditService service = UpmsUserCredit.service();
