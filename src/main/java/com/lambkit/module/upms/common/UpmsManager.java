...
import com.lambkit.module.upms.rpc.service.impl.UpmsSignServiceImpl;
...
import com.lambkit.module.upms.rpc.service.mock.UpmsCreditServiceMock;
...
import com.lambkit.module.upms.rpc.service.mock.UpmsSignServiceMock;
...
import com.lambkit.module.upms.rpc.service.mock.UpmsUserCreditServiceMock;
...
import com.lambkit.module.upms.server.tag.UpmsCreditDirective;
...
import com.lambkit.module.upms.server.tag.UpmsSignDirective;
import com.lambkit.module.upms.server.tag.UpmsSystemDirective;
import com.lambkit.module.upms.server.tag.UpmsTagDirective;
import com.lambkit.module.upms.server.tag.UpmsUserCreditDirective;
...
public class UpmsManager {
	...
	public void mapping(ActiveRecordPluginWrapper arp) {
		...
		arp.addMapping("upms_credit", "id", UpmsCredit.class);
		arp.addMapping("upms_sign", "id", UpmsSign.class);
		arp.addMapping("upms_user_credit", "user_id", UpmsUserCredit.class);
	}
	...
	public void addTag(LambkitModule lk) {
		...
		lk.addTag("upmsCredit", new UpmsCreditDirective());
		lk.addTag("upmsSign", new UpmsSignDirective());
		lk.addTag("upmsUserCredit", new UpmsUserCreditDirective());
	}
	...
	public void registerLocalService(String group, String version, int port) {
		...
		ServiceManager.me().mapping(UpmsCreditService.class, UpmsCreditServiceImpl.class, UpmsCreditServiceMock.class, group, version, port);
		ServiceManager.me().mapping(UpmsSignService.class, UpmsSignServiceImpl.class, UpmsSignServiceMock.class, group, version, port);
		ServiceManager.me().mapping(UpmsUserCreditService.class, UpmsUserCreditServiceImpl.class, UpmsUserCreditServiceMock.class, group, version, port);
	}
	...
	public void registerRemoteService(String group, String version, int port) {
		...
		ServiceManager.me().remote(UpmsCreditService.class, UpmsCreditServiceMock.class, group, version, port);
		ServiceManager.me().remote(UpmsSignService.class, UpmsSignServiceMock.class, group, version, port);
		ServiceManager.me().remote(UpmsUserCreditService.class, UpmsUserCreditServiceMock.class, group, version, port);
	}
	/*
